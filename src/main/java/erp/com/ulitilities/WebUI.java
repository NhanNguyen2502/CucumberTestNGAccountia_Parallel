...
public class WebUI {
    ...
    private final static long PAGE_LOAD_TIMEOUT_FOR_CLICK = ConstantGlobal.PAGE_LOAD_TIMEOUT_FOR_CLICK;
    ...
    public static List<WebElement> getListElements(By by) {
        var _listElements = DriverManager.getDriver().findElements(by);
        return _listElements;
    }

    public static boolean checkDisplayed(By by) {
        boolean a = false;
        var _elements = getListElements(by);
        if (_elements.size() > 0) {
            a = true;
        }
        return a;
    ...
    public static boolean checkNull(By by) {
        var _list = DriverManager.getDriver().findElements(by);
...
//    }
    ...
    public static void openURL(String url) {
        ...
        if (PropertiesHelper.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureHelper.takeScreenshot("openURL_" + SystemHelpers.makeSlug(url));
        }
    }
    ...
    public static void clickElement(By by) {
        ...
        if (PropertiesHelper.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureHelper.takeScreenshot("clickElement_" + SystemHelpers.makeSlug(by.toString()));
        }
    }
    ...
    public static void setText(By by, String value) {
        ...
        if (PropertiesHelper.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureHelper.takeScreenshot("setText_" + SystemHelpers.makeSlug(by.toString()));
        }
    }
    ...
    public static void scrollToElement(WebElement element) {
        ...
        if (PropertiesHelper.getValue("SCREENSHOT_STEP").equals("yes")) {
            CaptureHelper.takeScreenshot("scrollToElement_" + SystemHelpers.makeSlug(element.getText()));
        }
    }
    ...
    //Wait after click or enter text to element
    public static void waitAfterClick() {
        WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(PAGE_LOAD_TIMEOUT_FOR_CLICK));
        JavascriptExecutor js = ((JavascriptExecutor) DriverManager.getDriver());
        ExpectedCondition<Boolean> jsLoad = driver -> ((JavascriptExecutor) DriverManager.getDriver()).executeScript("return document.readyState").toString().equals("complete");
        boolean jsReady = js.executeScript("return document.readyState").toString().equals("complete");
        try {
...
//    public static void waitForLoadJsLoginPage() {
//        WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(PAGE_LOAD_TIMEOUT));
